...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry config) {
        config.enableSimpleBroker("/topic");  // Enables in-memory message broker with /topic as the base path
        config.setApplicationDestinationPrefixes("/app");  // Defines the application message prefix
    }
